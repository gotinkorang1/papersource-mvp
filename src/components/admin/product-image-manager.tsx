  ...
  return (
    <div className="mt-4 space-y-5">
      <div className="rounded-lg border border-dashed border-border bg-cream/30 p-4 dark:bg-ink/30">
        ...
        {items.some((item) => item.status === "done") ? <button type="button" className={paperButton({ className: "mt-4 min-h-11" })} onClick={() => void saveAllImages()} disabled={items.some((item) => item.status === "saving")}>Save all uploaded images</button> : null}
      </div>
