...
export function CataloguePagination({ page, totalPages, query, totalItems, pageSize = 24 }: { page: number; totalPages: number; query: Record<string, string>; totalItems?: number; pageSize?: number }) {
